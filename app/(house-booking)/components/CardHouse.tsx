...
export default function CardHouse({ house }: CardHouseProps) {
  return (
    <Link href={{ pathname: "/house/[id]", params: { id: house.id } }} asChild>
      <Pressable>
        <Card variant="elevated" className="p-0 rounded-2xl h-[240px] mb-5">
          <Image
            source={house.image}
          ...
          <HStack
            space="md"
            className="absolute bg-slate-900/40 bottom-5 mx-3 px-2 py-1 rounded-xl"
          >
